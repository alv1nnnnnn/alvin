...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-16">
  ...
  <div class="border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden mb-3 animate-fade-up stagger-6">
    ...
    <div class="p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5">
      ...
      <!-- Email -->
      <a href="mailto:alvinnario56@gmail.com"
         class="border border-zinc-200 dark:border-zinc-800 rounded-lg p-3 flex items-center gap-3 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
        <svg class="w-5 h-5 flex-shrink-0 text-black dark:text-white" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
          <rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 7l10 7 10-7"/>
        </svg>
        <div class="min-w-0">
          <span class="text-xs font-semibold uppercase tracking-widest text-black dark:text-white block">Email</span>
          <span class="text-xs font-medium text-blue-600 truncate block">alvinnario56@gmail.com</span>
        </div>
      </a>
 
      <!-- GitHub -->
      <a href="https://github.com/alv1nnnnnn"
         target="_blank"
         rel="noopener noreferrer"
         class="border border-zinc-200 dark:border-zinc-800 rounded-lg p-3 flex items-center gap-3 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
        <svg class="w-5 h-5 flex-shrink-0 text-black dark:text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="min-w-0">
          <span class="text-xs font-semibold uppercase tracking-widest text-black dark:text-white block">GitHub</span>
          <span class="text-xs font-medium text-blue-600 truncate block">https://github.com/alv1nnnnnn</span>
        </div>
      </a>
 
      <!-- LinkedIn -->
      <a href="https://www.linkedin.com/in/alvin-nario-00146635a"
         target="_blank"
         rel="noopener noreferrer"
         class="border border-zinc-200 dark:border-zinc-800 rounded-lg p-3 flex items-center gap-3 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
        <svg class="w-5 h-5 flex-shrink-0 text-[#0A66C2]" fill="currentColor" viewBox="0 0 24 24">
          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
        </svg>
        <div class="min-w-0">
          <span class="text-xs font-semibold uppercase tracking-widest text-black dark:text-white block">LinkedIn</span>
          <span class="text-xs font-medium text-blue-600 truncate block">https://www.linkedin.com/in/alvin-nario-00146635a</span>
        </div>
      </a>
 
      <!-- Facebook -->
      <a href="https://www.facebook.com/alv.nnnnnnn"
         target="_blank"
         rel="noopener noreferrer"
         class="border border-zinc-200 dark:border-zinc-800 rounded-lg p-3 flex items-center gap-3 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
        <svg class="w-5 h-5 flex-shrink-0 text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="min-w-0">
          <span class="text-xs font-semibold uppercase tracking-widest text-black dark:text-white block">Facebook</span>
          <span class="text-xs font-medium text-blue-600 truncate block">https://www.facebook.com/alv.nnnnnnn</span>
        </div>
      </a>
  ...
  function portfolio() {
    return {
      ...
      techStack: [
        ...
        { label: 'Backend',        items: ['PHP', 'Laravel', 'Livewire', 'MySQL', 'AWS Lambda', 'DynamoDB', 'OAuth', 'JWT', 'REST', 'Express.js', 'MongoDB'] },
      ...
      projects: [
        ...
        { name: 'Plate — Restaurant Finder',                                         desc: 'Plate is a modern, full-stack web app that lets users search for restaurants in any city around the world. It is built with a clean separation between a React frontend and a Node.js/Express backend, using the Yelp Fusion API as its data source.',                 year: '2026',      demo: 'https://global-restaurant-finder.vercel.app/' },
      ],
